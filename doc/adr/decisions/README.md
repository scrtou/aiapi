...
| [ADR-07](./ADR-07-provider-template-method.md) | 生产 Provider 继承薄 ProviderBase + 可组合策略 | 部分实施（P6-W3：两家活跃 Provider 已切片） |
...
| [ADR-11](./ADR-11-production-test-targets.md) | 生产库唯一 source owner，正式 target strangler 迁移 | 迁移中（legacy ceiling 19） |
