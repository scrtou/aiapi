...
| [ADR-05](./ADR-05-result-type.md) | 跨层失败使用 Result，按垂直切片迁移 | 部分实施（P6-W2：Chayns 已切片） |
| [ADR-06](./ADR-06-composition-root.md) | 组合根替代业务 Service Locator | 迁移中 |
| [ADR-07](./ADR-07-provider-template-method.md) | 生产 Provider 继承薄 ProviderBase + 可组合策略 | 部分实施（P6-W2：Chayns 已切片） |
