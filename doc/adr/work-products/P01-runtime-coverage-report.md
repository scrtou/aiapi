...
|---|---:|
| production 实现文件 | 65 |
| 已编入并 instrument 的实现文件 | 38 |
| 未编入测试 target 的实现文件 | 27 |
| 行覆盖（仅已 instrument 实现） | 3628/8526 (42.55%) |
| 分支覆盖（仅已 instrument 实现） | 5169/25189 (20.52%) |
| gcda 文件 | 73 |
...
| 路径 | 文件 | 状态 | 行 | 分支 |
|---|---|---|---:|---:|
| Chayns generate/postChatMessage | `src/apipoint/chaynsapi/chaynsapi.cpp` | `not_instrumented` | n/a | n/a |
...
| Account selection/invalidation/rollback/pool rebuild | `src/accountManager/accountManager.cpp` | `instrumented` | 191/1760 (10.85%) | 316/6937 (4.56%) |
...
| 路径 | 函数 | 状态 | 执行次数 | 行 | 分支 |
|---|---|---|---:|---:|---:|
| Chayns generate/postChatMessage | `chaynsapi::generate(` | `not_instrumented` | n/a | n/a | n/a |
| Chayns generate/postChatMessage | `chaynsapi::postChatMessage(` | `not_instrumented` | n/a | n/a | n/a |
...
| Account selection/invalidation/rollback/pool rebuild | `AccountManager::getEligibleAccount(` | `not_executed` | 0 | 0/68 (0.00%) | 0/140 (0.00%) |
...
| Account selection/invalidation/rollback/pool rebuild | `AccountManager::loadAccount(` | `executed` | 7 | 12/13 (92.31%) | 32/50 (64.00%) |
...
| `src/accountManager/accountManager.cpp` | `executed` | 191/1760 (10.85%) | 316/6937 (4.56%) |
| `src/apiManager/ApiFactory.cpp` | `instrumented_not_executed` | 0/13 (0.00%) | 0/10 (0.00%) |
| `src/apiManager/ApiManager.cpp` | `executed` | 12/63 (19.05%) | 9/174 (5.17%) |
| `src/apipoint/chaynsapi/ChaynsMessageCorrelation.cpp` | `executed` | 73/86 (84.88%) | 102/190 (53.68%) |
...
| `src/sessionManager/continuity/HistoryReplayBudget.cpp` | `executed` | 147/181 (81.22%) | 164/332 (49.40%) |
