...
class AiApiController : public drogon::HttpController<AiApiController>
{
  public:
    ...
    ADD_METHOD_TO(AiApiController::chaynsapichat, "/nexosapi/v1/chat/completions", drogon::Post, "RateLimitFilter");
    ADD_METHOD_TO(AiApiController::chaynsapimodels, "/chaynsapi/v1/models", drogon::Get);
    ADD_METHOD_TO(AiApiController::chaynsapimodels, "/nexosapi/v1/models", drogon::Get);
    ADD_METHOD_TO(AiApiController::nexosAccountQuota, "/nexosapi/v1/account/quota", drogon::Get);
    ...
    ADD_METHOD_TO(AiApiController::responsesCreate, "/nexosapi/v1/responses", drogon::Post, "RateLimitFilter");
    ADD_METHOD_TO(AiApiController::responsesGet, "/chaynsapi/v1/responses/{1}", drogon::Get);
    ADD_METHOD_TO(AiApiController::responsesGet, "/nexosapi/v1/responses/{1}", drogon::Get);
    ADD_METHOD_TO(AiApiController::responsesDelete, "/chaynsapi/v1/responses/{1}", drogon::Delete);
    ADD_METHOD_TO(AiApiController::responsesDelete, "/nexosapi/v1/responses/{1}", drogon::Delete);
    METHOD_LIST_END
    ...
    void nexosAccountQuota(const drogon::HttpRequestPtr &req, std::function<void(const drogon::HttpResponsePtr &)> &&callback);
